...
const AddToCartButton = ({ cartItemData, disabled }: TProps) => {
  ...
  return (
    <button
      disabled={disabled}
      className={
        "flex justify-center items-center gap-5 cursor-pointer ml-6 sm:ml-10 text-sm sm:text-lg font-light px-8 sm:px-12 py-2.5 bg-aurex-red-500 rounded-lg text-white transition-all duration-300"
      }
